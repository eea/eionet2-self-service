...
import "./UserEdit.css";
import { Box, TextField, Autocomplete, Button, FormLabel, CircularProgress, Chip, Paper, InputLabel } from "@mui/material";
        ...
        <div className="main">
            <div >
                ...
                >
                    ...
                    <div className="row">
                        <FormLabel className="note-label control">{user.SelfSeviceHelpdeskPersonalDetailsText} </FormLabel>
                    </div>
                    <div className="row">
                        <Autocomplete
                            disablePortal
                    ...
                    <div className="row">
                        <TextField disabled required autoComplete='off' className="control" id="lastName" label="Country" variant="standard" defaultValue={user.Country} />
                        ...
                        <TextField disabled required autoComplete='off' className="control" id="lastName" label="Organisation" variant="standard" defaultValue={user.Organisation}
                        />
                    </div>
                    <div className="row">
                        {user.Memberships &&
                            <div>
                                ...
                                >
                                    {user.Memberships.map((data) => {
                                        return (
                                            <Chip className="chip" label={data} />
                                        );
                                    })}</Paper>
                            </div>}
                        ...
                        {user.NFP &&
                            <div>
                                ...
                                <Paper className="paper" >
                                    <Chip className="chip" label={user.NFP} /></Paper>
                            </div>}
                    </div>
                    <div className="row">
                        <FormLabel className="note-label control">Note: If the email or other details needs to be changed, kindly contact Eionet Helpdesk. </FormLabel>
                    </div>
                    <div className="row">
                ...
                <Box>
                    ...
                    <div className="row">
                        <FormLabel className="note-label control">{user.SelfSeviceHelpdeskPreferencesText} </FormLabel>
                    </div>
                </Box>
